...
in {
  ...
  home.username = "arthvm";
  home.homeDirectory = "/home/arthvm";
  home.pointerCursor = {
    x11.enable = true;
    gtk.enable = true;
  ...
  xdg.configFile.nvim.source = mkOutOfStoreSymlink "/home/arthvm/.dotfiles/.config/nvim";
  xdg.dataFile.password-store.source = mkOutOfStoreSymlink "/home/arthvm/.password-store";
